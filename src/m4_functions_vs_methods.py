...
def try_methods():
    window=rg.TurtleWindow()
    cars=rg.SimpleTurtle()
    cars.pen=rg.Pen('brown',5)
    cars.forward(150)
    cars.left(90)
    cars.forward(50)
    cars.backward(100)
...
def try_methods_and_functions():
    little_bomber=rg.SimpleTurtle()
    little_bomber.pen=rg.Pen('blue',5)
    little_bomber.backward(150)
    little_bomber.speed=1
    draw_many_squares(little_bomber,2,100,30)
    little_bomber.speed=5
    little_bomber.pen=rg.Pen('red',5)
    draw_many_squares(little_bomber,10,50,15)
    little_bomber.speed=100
    little_bomber.pen=rg.Pen('red',35)
    draw_many_squares(little_bomber,8,300,60)
    little_bomber.pen=rg.Pen('black',3)
    little_bomber.backward(200)
    little_bomber.draw_square(50)
    """
    Constructs a SimpleTurtle and sets its   pen  to a new rg.Pen
